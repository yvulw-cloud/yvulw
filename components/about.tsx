...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"briefcase","title":"회사명","period":"2020 - 현재","description":"직무 및 역할"},{
  "icon": "graduation",
  "title": "학교명",
  "period": "2016 - 2025",
  "description": "2020 용인 서원고등학교 졸업\n2023 단국대학교 도시계획부동산학부 입학\n(전공 및 학위: 재학 중)"
},{"icon":"award","title":"자격증/수상","period":"2021","description":"설명을 입력하세요"}],
